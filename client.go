...
// Subscribe function should be used to listen for events from the StreamClient TopicName. The fromBeginning param should be true
// to read from the beginning. The provided EventHandler function will be called for each value.
